...
contactsRouter.post("/", ctrlWrapper(contactsControllers.addContactsController));

contactsRouter.put("/:id", ctrlWrapper(contactsControllers.upsertContactsController));

contactsRouter.patch("/:id", ctrlWrapper(contactsControllers.patchContactsController));
